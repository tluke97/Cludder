...
class PostImage4Cell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        picture4.translatesAutoresizingMaskIntoConstraints = false
    ...
    func setupViews() {
        ...
        self.contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-15-[username(25)]-10-[caption]-10-[picture(70)]-3-[picture2(70)]-10-[likeLabel(20)]-10-[likeButton(40)]-5-|", options: [], metrics: nil, views: ["username":username, "caption":caption, "likeLabel":likeCount, "likeButton":likeButton, "picture":picture, "picture2":picture2]))
        self.contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-15-[username(25)]-10-[caption]-10-[picture3(70)]-3-[picture4(70)]-10-[likeLabel(20)]-10-[commentButton(40)]-5-|", options: [], metrics: nil, views: ["username":username, "caption":caption, "likeLabel":likeCount, "commentButton":commentButton, "picture3":picture3, "picture4":picture4]))
        //self.contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-15-[username(25)]-10-[caption]-10-[picture(160)]-10-[likeLabel(20)]-10-[commentButton(40)]-5-|", options: [], metrics: nil, views: ["username":username, "caption":caption, "likeLabel":likeCount, "commentButton":commentButton, "picture":picture2]))
        ...
        self.contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-15-[profilePic(70)]-10-[picture2(==picture4)]-3-[picture4]-10-|", options: [], metrics: nil, views: ["profilePic":profilePic, "picture2":picture2, "picture4":picture4]))
